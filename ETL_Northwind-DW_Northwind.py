...
def transform():
    ...
    log(logfile, "-------------------------------------------------------------")
    return df_fact_order,df_category,df_customer,df_employee,df_location,df_product,df_shipper,df_supplier
   
def load():
    """ Connect to the PostgreSQL database server """
    conn_string = 'postgresql://postgres:172164@localhost/DW_Northwind'
...
if __name__ == '__main__':
    ...
    extract()
    ( df_fact_order,df_category,df_customer,df_employee,df_location,df_product,df_shipper,df_supplier) = transform()
    load()
